...
class TestCard(unittest.TestCase):
    ...
    def testAceDisplay(self):
        card = Card('♠', 1)
        self.assertEqual('Ace of ♠', str(card))

    def testNumberCardDisplay(self):
        card = Card('♥', 10)
        self.assertEqual('10 of ♥', str(card))

    def testJackCardDisplay(self):
        card = Card('♦', 11)
        self.assertEqual('Jack of ♦', str(card))

    def testQueenCardDisplay(self):
        card = Card('♣', 12)
        self.assertEqual('Queen of ♣', str(card))

    def testKingCardDisplay(self):
        card = Card('♥', 13)
        self.assertEqual('King of ♥', str(card))
